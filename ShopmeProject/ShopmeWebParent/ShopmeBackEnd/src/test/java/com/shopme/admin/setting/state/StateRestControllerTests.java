...
public class StateRestControllerTests {
    ...
    @Test
    @WithMockUser(username = "someone", password = "something", roles = "Admin")
    ...
    public void testCreateState() throws Exception {
        ...
        Integer statedId = Integer.parseInt(response);
        Optional<State> findById = stateRepo.findById(statedId);
